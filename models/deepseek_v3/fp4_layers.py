...
class FP4Linear(torch.autograd.Function):
    ...
    def forward(ctx, x, weight, bias=None):
        ...
        fp4_w, fp4_s = nvfp4_quantize(weight.to(torch.bfloat16), weight_global_sf, sfLayout=SfLayout.layout_128x4, do_shuffle=True)
        out = mm_fp4(x_fp4, fp4_w.T, x_scale, fp4_s.T, 1.0/(x_global_sf * weight_global_sf), torch.bfloat16, None, backend='trtllm')
